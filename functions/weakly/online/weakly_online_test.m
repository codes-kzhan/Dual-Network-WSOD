function [res, mean_loc] = weakly_online_test(confs, imdb, roidb, varargin)
% --------------------------------------------------------
      ...
      for i = 1:num_images
        ...
        for j = 1:num_classes
            ...
            if (isempty(aboxes_map_fusion{j}{i}))
              aboxes_map_fusion{j}{i} = temp ./ num_nets;
            else
              aboxes_map_fusion{j}{i} = temp ./ num_nets + aboxes_map_fusion{j}{i};
            end
